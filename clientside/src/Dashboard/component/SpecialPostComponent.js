...
import { deletePostApi } from '../../components/States/postIntegration/postApi'
const SpecailDashboardComponent = ({post, setPosts}) => {
    ...
    const handleDelete = async ()=>{
        const deleted = await deletePostApi(post._id);
        setPosts((prev)=>{
            const a = [...prev];
...
export default SpecailDashboardComponent